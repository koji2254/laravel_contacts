<x-min-nav>
    ...
    <div class="m-auto w-80 bg-gray-50 p-3 my-2">
            ...
            <div>
                ...
                @enderror
                  ...
                  <button id="login-button" type="submit" class="w-full text-white bg-emerald-600 hover:bg-emerald-700 focus:ring-4 focus:outline-none focus:ring-emerald-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-emerald-600 dark:hover:bg-emerald-700 dark:focus:ring-emerald-800"> Login </button>
                  <p class="text-md font-light text-gray-500 dark:text-gray-400">
                      create new account? <a href="/register" class="font-medium text-md text-blue-600 hover:underline dark:text-emerald-500">sign-up </a>
                  </p>
              </form>
            </div>
    ...
    <script src="{{ asset('js/auth_02.js') }}"></script>
</x-min-nav>